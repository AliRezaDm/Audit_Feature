...
class Supply(models.Model):
    ...
    color = models.ManyToManyField('Color' ,related_name='goods', verbose_name='رنگ', default='بدون رنگ')
    size = models.ManyToManyField('Size', related_name='goods', verbose_name='اندازه', default='بدون اندازه')
